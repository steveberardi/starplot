...
class TestLanguages:
    ...
    @pytest.mark.parametrize("star_hip_id, language, expected_value", [
        (11767, "en-us", "Polaris"),
    ...
    @pytest.mark.parametrize("constellation_id, language, expected_value", [
    ...
    @pytest.mark.parametrize("messier, language, expected_value", [
