...
class TestMoon:
    def test_moon_get(self):
        ...
        assert m.dt == dt
        assert m.apparent_size == 0.5480758930286621
    ...
    def test_moon_get_new_moon(self):
        ...
        assert m.phase_angle == 356.289419807477
        assert m.illumination == 0.02061433440290572
    ...
    def test_moon_get_full_moon(self):
        ...
        assert m.phase_angle == 175.42641242000826
        assert m.illumination == 0.974591180111157
...
class TestPlanet:
    def test_planet_get(self):
        ...
        assert jupiter.apparent_size == 0.00916289062469268
