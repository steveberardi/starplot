...
def e2e_optic_polaris_binoculars():
    ...
    optic_plot.info()
    filename = actual_filename("optic_polaris_binoculars")
    optic_plot.export(filename)
    return filename


def e2e_optic_orion_nebula_refractor():
    optic_plot = OpticPlot(
        # Orion Nebula
        ra=5.583 * 15,
        dec=-5.383,
    ...
    optic_plot.nebula()
    optic_plot.info()
    filename = actual_filename("optic_orion_nebula_refractor")
    optic_plot.export(filename)
    return filename


def e2e_optic_wrapping():
    optic_plot = OpticPlot(
        ra=23.99 * 15,
        dec=17.573889,
    ...
    optic_plot.info()
    filename = actual_filename("optic_wrapping")
    optic_plot.export(filename)
    return filename


def e2e_optic_clipping():
    optic_plot = OpticPlot(
        # Orion Nebula
        ra=5.583 * 15,
        dec=-5.383,
    ...
    filename = actual_filename("optic_clipping")
    optic_plot.export(filename)
    return filename


def e2e_optic_m45_binoculars():
    optic_plot = OpticPlot(
        # M45
        ra=3.7836111111 * 15,
        dec=24.1166666667,
    ...
    optic_plot.stars(where=[_.magnitude < 12])
    optic_plot.info()
    filename = actual_filename("optic_m45_binoculars")
    optic_plot.export(filename)
    return filename


def e2e_optic_m45_scope():
    optic_plot = OpticPlot(
        # M45
        ra=3.7836111111 * 15,
        dec=24.1166666667,
    ...
    optic_plot.info()
    filename = actual_filename("optic_m45_scope")
    optic_plot.export(filename)
    return filename


def e2e_optic_m45_scope_gradient():
    ...
    optic_plot.info()
    filename = actual_filename("optic_m45_scope_gradient")
    optic_plot.export(filename)
    return filename


def e2e_optic_m45_reflector():
    optic_plot = OpticPlot(
        # M45
        ra=3.7836111111 * 15,
        dec=24.1166666667,
    ...
    optic_plot.stars(where=[_.magnitude < 12])
    optic_plot.info()
    filename = actual_filename("optic_m45_reflector")
    optic_plot.export(filename)
    return filename


def e2e_optic_m45_camera():
    optic_plot = OpticPlot(
        # M45
        ra=3.7836111111 * 15,
        dec=24.1166666667,
    ...
    optic_plot.info()
    filename = actual_filename("optic_m45_camera")
    optic_plot.export(filename)
    return filename


def e2e_optic_camera_rotated():
    optic_plot = OpticPlot(
        # M45
        ra=3.7836111111 * 15,
        dec=24.1166666667,
    ...
    optic_plot.stars(where=[_.magnitude < 12])
    optic_plot.info()
    filename = actual_filename("optic_camera_rotated_m45")
    optic_plot.export(filename)
    return filename


def e2e_optic_solar_eclipse_binoculars():
    observer = Observer(
        dt=dt_april_8,
        lat=33.363484,
        lon=-116.836394,
    ...
    filename = actual_filename("optic_binoculars_eclipse")
    optic_plot.export(filename)
    return filename


def e2e_optic_moon_phase_waxing_crescent():
    ...
    filename = actual_filename("optic_moon_phase_waxing_crescent")
    optic_plot.export(filename)
    return filename


def e2e_optic_moon_phase_new():
    observer = Observer(
        dt=dt_april_8,
        **POWAY,
    )
    ...
    filename = actual_filename("optic_moon_phase_new")
    optic_plot.export(filename)
    return filename


def e2e_optic_moon_phase_full():
    ...
    filename = actual_filename("optic_moon_phase_full")
    optic_plot.export(filename)
    return filename


def e2e_optic_iss_moon_transit():
    tz_pacific = ZoneInfo("US/Pacific")
    dt = datetime(2025, 12, 8, 8, 3, 16, tzinfo=tz_pacific)
    style = styles.PlotStyle().extend(
        styles.extensions.BLUE_DARK,
        styles.extensions.OPTIC,
    )
    ...
    filename = actual_filename("optic_iss_moon_transit")
    p.export(filename)
    return filename
