...
- [Example of using gradient on horizon plot](../examples/horizon-gradient.md)
- [Example of using a gradient on a polygon](../examples/optic-solar-eclipse.md)
- [Example of using gradients on stars](../examples/optic-m45.md)
