...
[< Back to Changelog](../changelog.md#v016x)
...
[Projections are now classes](../reference-mapplot.md#projections) instead of an enum. This was a difficult decision, but I think it's the best way to allow customizing the central RA/DEC of projections, and this is something I really wanted to support.
