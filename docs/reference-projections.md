...
![Orthographic projection: gridlines and Tissot indicatrix](images/examples/projection_orthographic.svg){ .projection-img loading=lazy }
- __Gnomonic__{.fs-2}
![Gnomonic projection: gridlines and Tissot indicatrix](images/examples/projection_gnomonic.svg){ .projection-img loading=lazy }
