...
- <img src="images/examples/map_orion.png" width="600"> <h3>__Maps__</h3> shows an area that you define in one of many available map projections
...
<div class="star-list star-panel">
  ...
  <ul>
    ...
    <li><strong>Localization</strong> - label translations for Chinese, Dutch, French, Italian, Lithuanian, Persian, and Spanish</li>
  </ul>
...
<span class="title-icon" markdown>:material-rocket-launch: __Getting Started__{.ms-1}</span>
  ...
  2. [Tutorial](tutorial/index.md) - quick 30-minute intro to Starplot
