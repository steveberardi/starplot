...
- Using properties on those objects to [selectively plot stars](../reference-selecting-objects.md) (in this example, we use the constellation models to _only_ plot stars that are part of the lines in the constellation)
