...
<div class="info-panel bg-info columns-2" style="padding: 40px;">
    ...
    <div class="md-typeset">
        ...
        <div style="display: flex; align-items: center;">
            ...
            <a href="https://amzn.to/44YvgFZ"  style="line-height: 2.5em; margin-left: 20px;" target="_blank">
                Also available on <br/><img src="https://starplotting.com/images/amazon.png" class="off-glb" width="100"/>
            </a>
        </div>
