...
<div class="info-panel bg-info columns-2" style="padding: 40px;">
    ...
    <div class="md-typeset">
        ...
        <div style="display: flex; align-items: top;">
            <a href="https://steveberardimaps.com/products/all-sky-map" class="md-button md-button--primary" target="_blank" style="align-content: center; max-height: 60px;">
                Check it out
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="18" height="18" class="filter-blue-light" style="margin-left: 4px; vertical-align: text-top;"><path d="M3.75 2h3.5a.75.75 0 0 1 0 1.5h-3.5a.25.25 0 0 0-.25.25v8.5c0 .138.112.25.25.25h8.5a.25.25 0 0 0 .25-.25v-3.5a.75.75 0 0 1 1.5 0v3.5A1.75 1.75 0 0 1 12.25 14h-8.5A1.75 1.75 0 0 1 2 12.25v-8.5C2 2.784 2.784 2 3.75 2Zm6.854-1h4.146a.25.25 0 0 1 .25.25v4.146a.25.25 0 0 1-.427.177L13.03 4.03 9.28 7.78a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042l3.75-3.75-1.543-1.543A.25.25 0 0 1 10.604 1Z"></path></svg>
            </a>
            <a href="https://amzn.to/44YvgFZ"  style="margin-left: 24px;" target="_blank">
                Also available on <br/><img src="https://starplotting.com/images/amazon.png" class="off-glb" width="100" style="margin-top: 5px;"/>
            </a>
        </div>
    </div>
</div>
