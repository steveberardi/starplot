...
- `optic`: An instance of an [optic](../reference-models/#starplot.models.Optic). This example uses binoculars, but Starplot also supports refractor/reflector telescopes, generic scopes, and cameras.
